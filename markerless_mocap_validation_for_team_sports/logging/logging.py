...
def create_logger(
    name: str, user_config_path: str = "mcv_config.ini"
) -> logging.Logger:
    """Creates a logger with the given name, using the configuration files in the
    mcv package and the current working directory.

    To overwrite the base configuration of logging, create a `mcv_config.ini`
    ...
    The logging file `mcv.log` will appear in your working directory.

    Args:
        name (str): The name of the logger to create.
        user_config_path (str, optional): The path to the user configuration file.
